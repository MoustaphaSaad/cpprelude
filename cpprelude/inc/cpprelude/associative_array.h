...
namespace cpprelude
{
	...
	struct _RB_tree 
	{
		...
		struct RB_Node 
		{
			...
			RB_Node(const AllocatorT& allocator = AllocatorT())
			:color(color_type::RED), _allocator(allocator),
				left(nullptr), right(nullptr), parent(nullptr) 
			{}

			RB_Node(key_type k, const AllocatorT& allocator = AllocatorT())
				:key(k),, color(RED), _allocator(allocator),
				left(nullptr), right(nullptr), parent(nullptr)
			{}

			RB_Node(key_type k, value_type v, const AllocatorT& allocator = AllocatorT())
				:key(k), value(v), color(RED), _allocator(allocator),
				left(nullptr), right(nullptr), parent(nullptr)
			{}

			RB_Node(key_type k, value_type v, RB_Node* p, const AllocatorT& allocator = AllocatorT())
				:key(k), value(v), color(RED), _allocator(allocator),
...
*/
		...
		{
			RB_Node* temp = _allocator.template alloc<RB_Node>();
			new (temp) RB_Node(key, value);
